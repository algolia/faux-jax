...
XMLHttpRequest.prototype.send = function(body) {
  ...
  if (this.requestMethod === 'GET' || this.requestMethod === 'HEAD') {
    ...
    if (this._headerNames['content-type'] !== undefined) {
      var originalContentType = this.requestHeaders[this._headerNames['content-type']].split(';')[0];
      this.requestHeaders[this._headerNames['content-type']] = originalContentType + ';charset=UTF-8';
    } else {
